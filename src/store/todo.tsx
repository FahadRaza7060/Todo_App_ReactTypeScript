...
// -------- define children type here -----------
export type TodosProviderProps = {
    children : ReactNode
}

// ---- define the todos type ------
export type Todo = {
    id:string;
    task:string;
    completed:boolean;
...
// tell what type of data is present in our context
export type TodosContext = {
    todos:Todo[]; // todo of an array
